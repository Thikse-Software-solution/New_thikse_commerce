...
public class OrderService {
    ...
    public Order placeOrder(OrderDTO orderDTO) {
        ...
        // Reduce product stock via ProductService
        productService.reduceStock(product.getId(), orderDTO.getQuantity());
    ...
    public Order findOrderByRazorpayOrderId(String razorpayOrderId) {
        logger.info("Finding order by Razorpay Order ID: {}", razorpayOrderId);
