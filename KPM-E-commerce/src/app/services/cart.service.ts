...
export class CartService {
  ...
  private apiUrl = 'http://192.168.1.10:8080/api/cart'; // Base URL for cart API, replace with your actual backend URL
  ...
  addOrUpdateCartItem(
    ...
    if (productId == null || userId == null || quantity == null) {
      console.error('Invalid parameters for addOrUpdateCartItem:', {
        userId,
        productId,
        quantity,
      });
